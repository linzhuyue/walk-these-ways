...
from lcm_types.python.sim2real_leg_data import sim2real_leg_data
from lcm_types.python.rc_command_lcmt import rc_command_lcmt
from lcm_types.python.state_estimator_sim2real import state_estimator_sim2real
from lcm_types.python.camera_message_lcmt import camera_message_lcmt
from lcm_types.python.camera_message_rect_wide import camera_message_rect_wide
...
class StateEstimator:
    def __init__(self, lc, use_cameras=True):
        ...
        self.imu_subscription = self.lc.subscribe("rl_state_estimator_data", self._imu_cb)
        self.legdata_state_subscription = self.lc.subscribe("rl_leg_control_data", self._legdata_cb)
        self.rc_command_subscription = self.lc.subscribe("rl_rc_command", self._rc_command_cb)
    ...
    def _legdata_cb(self, channel, data):
        ...
        msg = sim2real_leg_data.decode(data)
        # print(msg.q)
    ...
    def _imu_cb(self, channel, data):
        # print("update imu")
        msg = state_estimator_sim2real.decode(data)
    ...
    def _rc_command_cb(self, channel, data):
        ...
        # print(f"self.right_upper_switch:{self.right_upper_switch}, right_upper_switch_pressed:{self.right_upper_switch_pressed}")

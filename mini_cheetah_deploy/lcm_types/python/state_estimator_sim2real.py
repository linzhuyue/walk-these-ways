...
class state_estimator_sim2real(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(state_estimator_sim2real._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != state_estimator_sim2real._get_packed_fingerprint():
            raise ValueError("Decode error")
        return state_estimator_sim2real._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = state_estimator_sim2real()
    ...
    def _get_hash_recursive(parents):
        if state_estimator_sim2real in parents: return 0
    ...
    def _get_packed_fingerprint():
        if state_estimator_sim2real._packed_fingerprint is None:
            state_estimator_sim2real._packed_fingerprint = struct.pack(">Q", state_estimator_sim2real._get_hash_recursive([]))
        return state_estimator_sim2real._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", state_estimator_sim2real._get_packed_fingerprint())[0]

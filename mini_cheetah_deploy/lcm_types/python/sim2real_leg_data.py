...
class sim2real_leg_data(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(sim2real_leg_data._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != sim2real_leg_data._get_packed_fingerprint():
            raise ValueError("Decode error")
        return sim2real_leg_data._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = sim2real_leg_data()
    ...
    def _get_hash_recursive(parents):
        if sim2real_leg_data in parents: return 0
    ...
    def _get_packed_fingerprint():
        if sim2real_leg_data._packed_fingerprint is None:
            sim2real_leg_data._packed_fingerprint = struct.pack(">Q", sim2real_leg_data._get_hash_recursive([]))
        return sim2real_leg_data._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", sim2real_leg_data._get_packed_fingerprint())[0]

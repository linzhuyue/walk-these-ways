...
class rc_command_lcmt(object):
    __slots__ = ["mode", "left_stick", "right_stick", "knobs", "left_upper_switch", "left_lower_left_switch", "left_lower_right_switch", "right_upper_switch", "right_lower_left_switch", "right_lower_right_switch"]

    __typenames__ = ["int16_t", "float", "float", "float", "int16_t", "int16_t", "int16_t", "int16_t", "int16_t", "int16_t"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">hhhhhh", self.left_upper_switch, self.left_lower_left_switch, self.left_lower_right_switch, self.right_upper_switch, self.right_lower_left_switch, self.right_lower_right_switch))
    ...
    def _decode_one(buf):
        ...
        self.left_upper_switch, self.left_lower_left_switch, self.left_lower_right_switch, self.right_upper_switch, self.right_lower_left_switch, self.right_lower_right_switch = struct.unpack(">hhhhhh", buf.read(12))
        return self

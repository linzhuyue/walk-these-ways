...
#ifndef __state_estimator_sim2real_hpp__
#define __state_estimator_sim2real_hpp__

#include <lcm/lcm_coretypes.h>



class state_estimator_sim2real
{
    public:
        float      p[3];
    ...
    public:
        ...
        /**
         * Returns "state_estimator_sim2real"
         */
...
int state_estimator_sim2real::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int state_estimator_sim2real::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int state_estimator_sim2real::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t state_estimator_sim2real::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* state_estimator_sim2real::getTypeName()
{
    return "state_estimator_sim2real";
}

int state_estimator_sim2real::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->contact_estimate[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
int state_estimator_sim2real::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->contact_estimate[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
int state_estimator_sim2real::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t state_estimator_sim2real::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xea87c8282effe5b6LL;

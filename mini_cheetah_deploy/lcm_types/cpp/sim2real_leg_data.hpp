...
#ifndef __sim2real_leg_data_hpp__
#define __sim2real_leg_data_hpp__

#include <lcm/lcm_coretypes.h>



class sim2real_leg_data
{
    public:
        float      q[12];
...
int sim2real_leg_data::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int sim2real_leg_data::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int sim2real_leg_data::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t sim2real_leg_data::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* sim2real_leg_data::getTypeName()
{
    return "sim2real_leg_data";
}

int sim2real_leg_data::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int sim2real_leg_data::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int sim2real_leg_data::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t sim2real_leg_data::_computeHash(const __lcm_hash_ptr *)
{
